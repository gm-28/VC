...
masks = dir('new_masks\*.png') ;     % folder of png mask
...
for ni=1:N_imgs
    ...
    img = imread(img_name);
    mask_name=fullfile('new_masks',masks(ni).name);
...
writematrix(Recall,'Task_2__3_Test_Data.xlsx','Sheet',2,'Range','H9');
writematrix(Precision,'Task_2__3_Test_Data.xlsx','Sheet',2,'Range','H10');
writematrix(F1,'Task_2__3_Test_Data.xlsx','Sheet',2,'Range','H11');
writematrix(tp,'Task_2__3_Test_Data.xlsx','Sheet',2,'Range','G5');
writematrix(fp,'Task_2__3_Test_Data.xlsx','Sheet',2,'Range','H5');
writematrix(fn,'Task_2__3_Test_Data.xlsx','Sheet',2,'Range','G6');
writematrix(tn,'Task_2__3_Test_Data.xlsx','Sheet',2,'Range','H6');
